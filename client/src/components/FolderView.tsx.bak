...
export function FolderView({ folder, onClose, onSelectFile, onRename }: FolderViewProps) {
  ...
  // Global mouse movement tracking to detect when cursor is over folder
  ...
  // Handle file drag-and-drop functionality - now handlers are defined before use
  useEffect(() => {
    ...
    const timeoutId = setTimeout(() => {
      ...
      // Add event listeners for folder dropzone
